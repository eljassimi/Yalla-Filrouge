<footer class="bg-darkgray relative overflow-hidden pt-16 pb-8">
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    <a href="#" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-white hover:bg-primary transition-colors">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="#" class="text-lightgray hover:text-primary transition-colors flex items-center">
            ...
            <div>
                ...
                <p class="text-lightgray mb-4">Subscribe to our newsletter for the latest updates on the 2030 FIFA World Cup.</p>
                <form class="mb-4">
                    <div class="relative">
                        <input type="email" placeholder="Your email address" class="w-full bg-gray-800 text-white border-none rounded-full py-3 px-5 focus:outline-none focus:ring-2 focus:ring-primary">
                        <button type="submit" class="absolute right-1 top-1 bg-primary hover:bg-primary/90 text-white rounded-full w-10 h-10 flex items-center justify-center transition-colors">
        ...
        <!-- Divider with Moroccan pattern -->
        <div class="relative py-6">
            <div class="absolute left-0 right-0 h-px bg-lightgray"></div>
            <div class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-darkgray px-4">
            </div>
        </div>
