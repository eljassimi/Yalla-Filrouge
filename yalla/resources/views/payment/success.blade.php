    ...
    <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="w-full bg-gray-900/50 p-6 md:p-8">
                <div class="flex flex-col items-center justify-center py-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 w-full max-w-md">
                        <a href="{{ route('ticket.download', ['payment' => $payment->id]) }}"
                           class="bg-primary hover:bg-primary/90 text-white py-3 px-6 rounded-lg font-bold transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg flex items-center justify-center">
        ...
        <div class="mt-8 text-center">
            <div class="flex items-center justify-center mb-2">
                ...
                <span class="text-lightgray text-sm">A confirmation email has been sent to your email address</span>
            </div>
            <p class="text-xs text-lightgray">If you have any questions, please contact our support team.</p>
        </div>
    </div>
</section>
